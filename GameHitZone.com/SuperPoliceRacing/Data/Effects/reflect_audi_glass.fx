...
float4 Specular = {0.99f, 0.99f, 0.99f, 1.0f};  // Specular color of the material
float  Reflectivity = 0.55f; // Reflectivity of the material
float  Power = 70.0f;
...
//    oPos = mul( oPos, g_mProj );
    ...
    // Compute lighting
    oDiffuse = dot( vNormal, -g_vLight);// * Diffuse;// + g_vAmbient * Ambient ;//normalize( g_vLight - oViewPos ) ) * Diffuse;
